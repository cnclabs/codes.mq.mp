...
def main(method, concat_original, base_model):
    ...
    for dataset_name in datasets:
        ...
        if concat_original == True:
            result_file = f"/home/intern/Leon_Kuo/Paper/Evaluation_Results/result-{method}-{dataset_name}-Concat_withO.json"
        else:
            result_file = f"/home/intern/Leon_Kuo/Paper/Evaluation_Results/result-{method}-{dataset_name}-Concat_withoutO.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', default='singleP', help='singleP or QQD(MILL)(mP)')
    parser.add_argument('--concat_original', action='store_true', help='Perform sampling on expanded queries')
    parser.add_argument('--base_model', default='e5-small-v2', help='e5-small-v2 or contriever')
    
    args = parser.parse_args()

    main(args.method, args.concat_original)